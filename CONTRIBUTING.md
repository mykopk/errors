...
Thank you for considering contributing to **@myko.pk/errors** — we appreciate every bug report, documentation fix, feature suggestion, and pull request.
...
2. Clone your fork:
   ```bash
   git clone https://github.com/mykopk/errors.git
   ```
...
```
src/
└── codes/         # Error code definitions and utilities
```
...
- **Error handling**: Extend base `MykoError` class for all custom errors
...
- Write tests for every new error class or utility
...
Open an issue at https://github.com/mykopk/errors/issues with:
